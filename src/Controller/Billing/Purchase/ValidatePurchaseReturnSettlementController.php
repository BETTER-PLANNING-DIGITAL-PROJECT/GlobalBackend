...
class ValidatePurchaseReturnSettlementController extends AbstractController
{
                             ...
                             Request $request): JsonResponse
    {
        ...
        $purchaseSettlement->getPurchaseReturnInvoice()?->setBalance($purchaseSettlement->getPurchaseReturnInvoice()->getTtc() - $purchaseSettlement->getPurchaseReturnInvoice()->getAmountPaid());
