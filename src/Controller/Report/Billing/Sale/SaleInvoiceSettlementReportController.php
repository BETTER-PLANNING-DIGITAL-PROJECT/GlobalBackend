...
#[AsController]
class SaleInvoiceSettlementReportController extends AbstractController
{
    ...
    #[Route('/api/get/sale-invoice-settlement/report', name: 'app_get_sale_invoice_settlement_history_report')]
    public function getSaleSettlementHistory(Request $request, SystemSettingsRepository $systemSettingsRepository): JsonResponse
    {
        ...
        $dql = 'SELECT id, invoice_id, customer_id, amount_pay, amount_rest FROM sale_settlement s WHERE sale_return_invoice_id is null AND is_validate = 1 ';
