...
#[AsController]
class CreatePurchaseInvoiceReceptionController extends AbstractController
{
                             ...
                             Request $request): JsonResponse
    {
        ...
        $reception->setDescription('purchase invoice draft delivery');
        ...
        if ($purchaseInvoiceItems)
        {
            foreach ($purchaseInvoiceItems as $purchaseInvoiceItem)
            {
                ...
                $receptionItem->setInstitution($purchaseInvoiceItem->getInstitution());
