...
#[AsController]
class PurchaseReturnInvoiceSettlementReportController extends AbstractController
{
    ...
    #[Route('/api/get/purchase-return-invoice-settlement/report', name: 'app_get_purchase_return_invoice_settlement_history_report')]
    public function getPurchaseSettlementHistory(Request $request, SystemSettingsRepository $systemSettingsRepository): JsonResponse
    {
        ...
        $dql = 'SELECT id, purchase_return_invoice_id, supplier_id, amount_pay, amount_rest FROM purchase_settlement s WHERE invoice_id is null AND is_validate = 1 ';
    ...
    public function bindPurchaseSettlement(PurchaseSettlement $purchaseSettlement): array
    {
        return [
            ...
            'returnInvoice' => $purchaseSettlement->getPurchaseReturnInvoice() ? $purchaseSettlement->getPurchaseReturnInvoice()->getId() :  '',
