...
#[AsController]
class CreatePurchaseReturnInvoiceDeliveryController extends AbstractController
{
                             ...
                             Request $request): JsonResponse
    {
        ...
        $delivery->setDescription('purchase return invoice draft delivery');
        $delivery->setIsValidate(false);
        ...
        if ($purchaseReturnInvoiceItems)
        {
            foreach ($purchaseReturnInvoiceItems as $purchaseReturnInvoiceItem)
            {
                ...
                $deliveryItem->setInstitution($purchaseReturnInvoiceItem->getInstitution());
